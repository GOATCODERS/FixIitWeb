...
SECRET_KEY = 'django-insecure-gpg0c^ev(3nv*lap&@sa5khx1yh_epy3o(j3_+=kz&c^44$nun'
...
LOGIN_URL = '/auth/login/'  # Update this to the correct login URL in your app
...
# Celery Settings
CELERY_BROKER_URL = 'redis://127.0.0.1:6379/0'  # Using Redis as the message broker
